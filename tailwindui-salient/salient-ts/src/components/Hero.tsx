...
import logoGmail from '@/images/logos/gmail.svg'
...
import logoTikTok from '@/images/logos/tiktok.svg'
...
export function Hero() {
  return (
    ...
    <span className="relative">Because you&apos;re in CNTRL</span>
  </span>
        </h1>
        ...
        <div className="mt-10 flex justify-center gap-x-6">
            <Button href="/register">Join the Wait List</Button>
            <Button
                href="https://www.youtube.com/watch?v=4Nu6DTTmPWo"
                variant="outline"
            >
                <svg
                    aria-hidden="true"
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
            Integrate AI Generation With These Platforms
        </p>
        <ul
          role="list"
